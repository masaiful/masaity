/* Vendored code of Codepen's "prefill embeds" script */
!(function(e) {
  var t = {};
  function r(n) {
  ...
  421: function(e, t, r) {
    ...
    var n = {
      ...
      v = function(e, t) {
        ...
        for (var a in ((e.data = (function(e) {
          if (e.hasAttribute('data-prefill')) {
            ...
            for (var i in (r = JSON.parse(decodeURI(r) || '{}')))
              o.indexOf(i) > -1 && (t[i] = r[i]);
            for (
              var a = e.querySelectorAll('[data-lang]'), s = 0;
              s < a.length;
              s++
            ) {
              var u = a[s],
        ...
        e))
          'prefill' !== a &&
            i.appendChild(_('input', { type: 'hidden', name: a, value: e[a] }));
        return i;
      },
      y = function(e) {
        var t,
          r = (function(e) {
            ...
            return [
              t,
              e.user ? e.user : 'anon',
              e.preview && 'true' === e.preview ? 'embed/preview' : 'embed',
              e['slug-hash'] + '?' + r,
            ]
              .join('/')
              .replace(/\/\//g, '//');
